        ...
        <v-main>
            <v-container fluid>
                ...
                <div v-if="loaded">
                    <v-row>
                        <v-col>
                            <v-card elevation="2" variant="outlined" v-if="hasPermissions">
                                <v-card-text>
                                    <v-icon end color="green">mdi-check-decagram</v-icon>
                                    <span>{{ i18n("permissions_host_message_enabled") }} </span>
                                </v-card-text>
                            </v-card>
                            <v-card elevation="2" variant="outlined" v-else>
                                <v-card-text>
                                    <v-icon end color="red">mdi-alert-circle-outline</v-icon>
                        ...
                        <v-col v-if="!hasPermissions">
                            <v-btn @click.stop="requestPermissions()">
                                ...
                                <v-icon end>mdi-check-decagram-outline</v-icon>
                            </v-btn>
                        </v-col>
                    </v-row>
                </div>
